...
namespace MAX.USPS
{
    public class USPSManager
    {
        ...
        private const string ProductionUrl = "https://production.shippingapis.com/ShippingAPI.dll";
        private const string TestingUrl = "https://testing.shippingapis.com/ShippingAPITest.dll";
