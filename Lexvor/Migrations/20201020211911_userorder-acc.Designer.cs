...
namespace Lexvor.Migrations
{
    ...
    [Migration("20201020211911_userorder-acc")]
    partial class userorderacc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserAccessory", b =>
                {
                    ...
                    b.Property<Guid?>("UserOrderId1")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("UserOrderId2")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("UserOrderId3")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserOrderId2");

                    b.HasIndex("UserOrderId3");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserAccessory", b =>
                {
                    b.HasOne("Lexvor.API.Objects.UserOrder", null)
                        .WithMany("Line1")
                    ...
                    b.HasOne("Lexvor.API.Objects.UserOrder", null)
                        .WithMany("Line3")
                        .HasForeignKey("UserOrderId2");

                    b.HasOne("Lexvor.API.Objects.UserOrder", null)
                        .WithMany("Line4")
                        .HasForeignKey("UserOrderId3");
                });
