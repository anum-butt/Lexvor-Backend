...
namespace Lexvor.Migrations
{
    ...
    [Migration("20210803222148_upgrade-deviceid")]
    partial class upgradedeviceid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lexvor.API.Objects.JobStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lexvor.API.Objects.PlanAccessory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LifetimeWarrantyPrice")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.PlanType", b =>
                {
                    ...
                    b.Property<bool>("AllowAccessoryPurchase")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowAffirmPurchases")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowStripePurchases")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.UsageDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserAccessory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserComm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserDevice", b =>
                {
                    ...
                    b.Property<string>("AffirmChargeId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("PurchasedWithAffirm")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("UpgradeAvailable")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserDocuments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lexvor.API.Objects.UserOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("Accessory1Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("Accessory2Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("Accessory3Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.UserPlan", b =>
                {
                    ...
                    b.Property<Guid?>("UpgradeDeviceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("WirelessPlanName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.User.UserDocuments", b =>
                {
                    ...
                    b.HasOne("Lexvor.API.Objects.UserPlan", "UserPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("Lexvor.API.Objects.UserOrder", b =>
                {
                    b.HasOne("Lexvor.API.Objects.User.UserAccessory", "Accessory1")
                        .WithMany()
                        .HasForeignKey("Accessory1Id");

                    b.HasOne("Lexvor.API.Objects.User.UserAccessory", "Accessory2")
                        .WithMany()
                        .HasForeignKey("Accessory2Id");

                    b.HasOne("Lexvor.API.Objects.User.UserAccessory", "Accessory3")
                        .WithMany()
                        .HasForeignKey("Accessory3Id");
            ...
            modelBuilder.Entity("Lexvor.API.Objects.UserPlan", b =>
                {
                    ...
                    b.HasOne("Lexvor.API.Objects.Device", "UpgradeDevice")
                        .WithMany()
                        .HasForeignKey("UpgradeDeviceId");
